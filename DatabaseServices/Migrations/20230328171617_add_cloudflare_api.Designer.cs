...
namespace DatabaseServices.Migrations
{
    ...
    [Migration("20230328171617_add_cloudflare_api")]
    partial class addcloudflareapi
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Models.Authentication.ApplicationRole", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Models.BusinessStuff.Business", b =>
                {
                    ...
                    b.Property<string>("CloudFlareApiTokenId")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasIndex("CloudFlareApiTokenId");
            ...
            modelBuilder.Entity("Models.Media.CloudFlareApiToken", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<System.Guid>", b =>
                {
                    b.HasOne("Models.Authentication.ApplicationRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<System.Guid>", b =>
                {
                    b.HasOne("Models.Authentication.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Models.BusinessStuff.Business", b =>
                {
                    b.HasOne("Models.Media.CloudFlareApiToken", "CloudFlareApiToken")
                        .WithMany()
                        .HasForeignKey("CloudFlareApiTokenId");
                    ...
                    b.Navigation("CloudFlareApiToken");
            ...
            modelBuilder.Entity("Models.BusinessStuff.Business", b =>
                {
                    b.Navigation("ActiveRotations");
                });

            modelBuilder.Entity("Models.BusinessStuff.Rotation", b =>
                {
                    b.Navigation("RotationMembers");
